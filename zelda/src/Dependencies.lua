...
require 'src/states/entity/player/PlayerHoldPotIdleState'
require 'src/states/entity/player/PlayerHoldPotWalkState'
...
gFrames = {
    ...
    ['character-pot-lift'] = GenerateQuads(gTextures['character-pot-lift'], 32, 32),
